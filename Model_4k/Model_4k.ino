...
//  unsigned long end_inference = millis();
 // Serial.println("Tiempo de interrupcion: ");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////PARTE FINAL///////////////////////////////////////////////////////////////////
Batch(output_2,output_2, gamma_19,beta_19,mean_19,variance_19,in_size,col);
Relu(output_2,col,in_size); 

Flatten(output_2,col,in_size);
